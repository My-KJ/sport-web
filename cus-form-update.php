...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="btn-group">
        <a href="profile-c.php" type="button" class="btn">ย้อนกลับ</a>
    ...
    <div class="container">
      ...
      <div class="profile-box">
        ...
        <p> E-Mail : <input type="email" class="form-control" id="email" name="email" placeholder="Input Your Email" value="<?php echo $row['email'] ?>" required ></p>
